...
class AyudaApplicantForm(ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            'name': TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter Full Name', 'min': '1'}),
            'city': Select(attrs={'class': 'form-control', 'placeholder': 'Enter City', 'min': '1'}),
            'dateofbirth': DateInput(attrs={'type': 'date', 'id': 'dob'}),
            'street1': TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter Street No., Compound/Village', 'min': '1'}),
            'street2': TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter Barangay, Postal Code', 'min': '1'}),
            'region': Select(attrs={'class': 'form-control', 'placeholder': 'Enter Region', 'min': '1'}),
